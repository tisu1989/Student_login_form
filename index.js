...
function validate() {
    ...
    if (st_name.length < 4) {
        document.getElementById('nameError').innerHTML = "Name must be greater than 4 character";
        status = false;
    }
    ...
    if (st_email.length < 5) {
        document.getElementById('emailError').innerHTML = "email cant be less than 5 character";
        status = false;
    }
     ...
     if (st_addr.length < 5) {
        document.getElementById('addrError').innerHTML ="Address should be greater than 5 digits";
    ...
    if (st_phone.length!=10) {
     ...
     if (st_course.length > 8) {
        document.getElementById('courseError').innerHTML ="Course should not be greater than 8 digits";
